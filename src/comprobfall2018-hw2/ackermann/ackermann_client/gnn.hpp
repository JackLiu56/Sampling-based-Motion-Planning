...
{ 
    ...
    */
    ...
    public:
        ...
        */
        graph_nearest_neighbors_t(std::function<bool (proximity_node_t*,proximity_node_t*)>,std::function<double (proximity_node_t*,proximity_node_t*)>,
                                  std::function<double (proximity_node_t*,proximity_node_t*)>);
        ...
        */
        bool add_node( proximity_node_t* node );
        ...
        */
        ...
        /**
        * Determine if two nodes are on the same component using DFS utility.
        * @param node1_index, node2_index. The index of two nodes.
        * @return If they are on the same component.
        */
        bool isSameComponents(int node1_index, int node2_index);
        /**
...
//        /**
//        * Find a feasible path from the start_node to the end node using DFS utility.
//        * @param start_index, end_index. The index of start_node and end_node.
//        * @return The indecies of nodes.
//        */
//        void findPath(int start_index, int end_index, int* path_index);



    protected:
        std::function<double (proximity_node_t*,proximity_node_t*)> distance_function;
        std::function<bool (proximity_node_t*,proximity_node_t*)> localvalid_function;
        std::function<double (proximity_node_t*,proximity_node_t*)> dis2line_function;
        /**
